---
layout: post
title:  "[멋사 백엔드 19기] TIL 67일차 미니프로젝트2 회고"
date:   2025-11-30 20:27:05 +0900
categories: 멋쟁이사자처럼 멋사 백엔드 TIL Project
---
...
- [Spring Boot 빌드를 위한 Gradle 의 필요 파일](#spring-boot-빌드를-위한-gradle-의-필요-파일)
- [Nginx 의 기본 홈페이지 경로](#nginx-의-기본-홈페이지-경로)
- [Docker Container 의 자동 실행 경로](#docker-container-의-자동-실행-경로)
- [nginx.conf 환경마다 달리 가져가기](#nginxconf-환경마다-달리-가져가기)
- [DBeaver(디비버) Public Key Retrieval is not allowed](#dbeaver디비버-public-key-retrieval-is-not-allowed)
- [DB 와 Back Container 간의 실행 시각 조정](#db-와-back-container-간의-실행-시각-조정)
- [WebMvcTest](#webmvctest)
- [Bash script 문자열 패턴 case 별 매칭](#bash-script-문자열-패턴-case-별-매칭)
- []()
